...
/******/ 	__webpack_require__.p = "/Users/wxf/Desktop/pkg/miya-php/public";
/******/
...
window.miya = {
	...
	fn: {
		...
		scrollResize: function scrollResize(callback, time, type) {
			//页面变化 滚动 或 尺寸
			if (type) {
		...
		exchange: function exchange(a, b) {
			if (window.$) {
				var n = a.next(),
				    p = b.prev();
				b.insertBefore(n);
